...
export const ApprovalRejectPage = () => {
        ...
        const fetchSearchResults = async () => {
            try {
                ...
                if (params.searchText && params.searchText.trim() !== '') {
                    ...
                    result = result.filter((post) => (post.approvalTitle && post.approvalTitle.toLowerCase().includes(searchLower)) ||
    ...
    return (_jsxs("div", { className: "mainpageContainer", children: [_jsx(Sidebar, {}), _jsxs("div", { className: "componentContainer", children: [_jsx(Header, {}), _jsxs("div", { className: "componentContainer1", children: [_jsx(ApprovalHeader, {}), _jsx(ApprovalSearchBar, { onSearch: handleSearch }), _jsx(ApprovalRejectBody, { selectedPosts: selectedPosts, setSelectedPosts: setSelectedPosts, filteredPosts: filteredPosts, setFilteredPosts: setFilteredPosts, currentPage: currentPage, postsPerPage: postsPerPage, onDelete: handleDelete }), _jsx(ApprovalFooter2, { pageInfo: {

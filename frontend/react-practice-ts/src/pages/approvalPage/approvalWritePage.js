...
export const ApprovalWritePage = () => {
    ...
    const [approvalNo, setApprovalNo] = useState(null); // 결재 번호 상태 추가
    useEffect(() => {
    ...
    const submitApproval = async () => {
        ...
        try {
            ...
            if (!newApprovalNo)
                throw new Error("approvalNo를 받지 못함");
    ...
    return (_jsxs("div", { className: "mainpageContainer", children: [_jsx(Sidebar, {}), _jsxs("div", { className: "componentContainer", children: [_jsx(Header, {}), _jsxs("div", { style: scrollableContentStyle, children: [_jsx(ApprovalWriteHeader, { approvalData: approvalData, setApprovalData: setApprovalData, selectedCCUsers: selectedCCUsers, setSelectedCCUsers: setSelectedCCUsers }), _jsx(ApprovalWriteBody, { approvalData: approvalData, setApprovalData: setApprovalData }), _jsx(ApprovalWriteFooter, { approvalData: approvalData, setApprovalMemoData: setApprovalMemoData, setApprovalData: setApprovalData, selectedCCUsers: selectedCCUsers, setSelectedCCUsers: setSelectedCCUsers, submitApproval: submitApproval, approvalNo: approvalNo })] })] })] }));
};
//  **스타일 정의 (TSX 내부에서 적용)**

...
export const ApprovalCompletePage = () => {
    return (_jsxs("div", { className: "mainpageContainer", children: [_jsx(Sidebar, {}), _jsxs("div", { className: "componentContainer", children: [_jsx(Header, {}), _jsxs("div", { style: scrollableContentStyle, children: [_jsx(ApprovalCompleteHeader, {}), _jsx(ApprovalCompleteDocument, {}), _jsx(ApprovalCompleteReply, {}), _jsx(ApprovalCompleteFooter, {})] })] })] }));
};
// ✅ **스타일 정의 (TSX 내부에서 적용)**

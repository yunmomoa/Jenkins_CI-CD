...
const Weather = () => {
    ...
    return (_jsxs("div", { className: styles.widgetContainer, children: [_jsxs("div", { className: styles.header, children: [_jsx("span", { children: "\uB0A0\uC528" }), _jsx("span", { className: styles.location, children: weather.name })] }), isLoading ? (_jsx("div", { className: styles.loadingContainer, children: _jsx(PacmanLoader, { color: "#4A90E2", cssOverride: {

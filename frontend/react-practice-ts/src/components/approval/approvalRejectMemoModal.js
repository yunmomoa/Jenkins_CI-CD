    ...
    return (_jsx("div", { style: {
            ...
            alignItems: "center",
                ...
                boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)", // :흰색_확인_표시: 그림자 추가
                        ...
                        fontWeight: "700",
                        marginBottom: "15px",
                    }, children: "\uBC18\uB824\uC0AC\uC720" }), _jsx("div", { style: {
                        fontSize: "14px",
                        fontWeight: "600",
                        marginBottom: "5px",
                    } }), _jsx("textarea", { value: memoContent, onChange: (e) => setMemocontent(e.target.value), placeholder: "\uBC18\uB824\uC0AC\uC720\uB97C \uC785\uB825\uD558\uC138\uC694", style: {
                        width: "100%",
                        ...
                        cursor: "pointer",
                        marginTop: "15px",
                    }, onClick: handleReject, children: "\uC800\uC7A5" })] }) }));
};

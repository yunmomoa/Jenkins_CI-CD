...
const ApprovalFavoriteLineModal = ({ onClose, approvalLines, refreshFavoriteList, userNo }) => {
    ...
    return (_jsx("div", { style: modalOverlay, children: _jsxs("div", { style: modalContainer, children: [_jsxs("div", { style: modalHeader, children: [_jsx("span", { style: modalTitle, children: "\uC990\uACA8\uCC3E\uAE30 \uBA85" }), _jsx("button", { style: closeButton, onClick: onClose, children: "\u00D7" })] }), _jsx("input", { type: "text", placeholder: "\uACB0\uC7AC\uB77C\uC778 \uC990\uACA8\uCC3E\uAE30 \uBA85 \uC785\uB825", value: favoriteName, onChange: (e) => setFavoriteName(e.target.value), style: inputStyle }), _jsx("button", { style: saveButton, onClick: saveFavoriteLine, disabled: loading, children: loading ? "저장 중..." : "저장" })] }) }));
};
// ✅ **스타일 정의**
const modalOverlay = {
    position: "fixed",

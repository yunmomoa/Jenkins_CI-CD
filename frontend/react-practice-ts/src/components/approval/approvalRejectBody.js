...
export const ApprovalRejectBody = ({ selectedPosts, setSelectedPosts, filteredPosts, setFilteredPosts, currentPage, postsPerPage, onDelete }) => {
    // 깃 이전 
    ...
    const currentPosts = Array.isArray(filteredPosts)
        ...
        : [];
    // 체크박스 핸들러
    const handleCheckbox = (approvalNo) => {
    ...
    const handleRowClick = async (approvalNo, event) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { style: containerStyle, children: _jsxs("table", { style: tableStyle, children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { style: thStyle, children: _jsx("input", { type: "checkbox", onChange: handleSelectAll, checked: posts.length > 0 && selectedPosts.length === posts.length }) }), _jsx("th", { style: thStyle, children: "\uAD6C\uBD84" }), _jsx("th", { style: thStyle, children: "\uAE30\uC548\uBC88\uD638" }), _jsx("th", { style: thStyle, children: "\uAE30\uC548\uC790" }), _jsx("th", { style: thStyle, children: "\uC81C\uBAA9" }), _jsx("th", { style: thStyle, children: "\uAE30\uC548\uC77C" }), _jsx("th", { style: thStyle, children: "\uC0C1\uD0DC" })] }) }), _jsx("tbody", { children: currentPosts.length > 0 ? (currentPosts.map((post) => (_jsxs("tr", { style: { ...rowStyle, cursor: "pointer" }, onClick: (e) => handleRowClick(post.approvalNo, e), children: [_jsx("td", { style: tdIconStyle, children: _jsx("input", { type: "checkbox", checked: selectedPosts.includes(post.approvalNo), onChange: () => handleCheckbox(post.approvalNo), onClick: (e) => e.stopPropagation() }) }), _jsx("td", { style: tdStyle, children: post.approvalType }), _jsx("td", { style: tdStyle, children: `기안-${post.approvalNo}` }), _jsx("td", { style: tdStyle, children: post.userName }), _jsx("td", { style: tdTitleStyle, children: post.approvalTitle }), _jsx("td", { style: tdStyle, children: post.startDate }), _jsx("td", { style: tdStyle, children: _jsx("span", { style: getStatusStyle(post.approvalStatus), children: getStatusText(post.approvalStatus) }) })] }, post.approvalNo)))) : (_jsx("tr", { children: _jsx("td", { colSpan: 8, style: { textAlign: 'center', padding: '20px' }, children: "\uAC80\uC0C9 \uACB0\uACFC\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." }) })) })] }) }), _jsxs("div", { style: {
                    display: 'flex',

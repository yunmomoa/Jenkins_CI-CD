...
const ApprovalWriteBody = ({ approvalData, setApprovalData }) => {
    ...
    return (_jsx("div", { style: { display: "flex", justifyContent: "center", alignItems: "center" }, children: _jsx(Editor, { apiKey: "kfbtq0klr5lef8kfjp5pkpy6g2mt9wjl1nwhtg76wek8u9v8", cloudChannel: "5", value: editorContent, onEditorChange: (content) => setEditorContent(content), init: {
                height: 550,
                width: 900,

...
export const ApprovalCompleteDocument = () => {
    ...
    const [fileName, setFileName] = useState("결재 문서.pdf");
    ...
    return (_jsxs("div", { style: containerStyle, children: [_jsxs("div", { style: fileInfoStyle, children: [_jsx("span", { style: fileNameStyle, children: fileName }), _jsx("a", { href: generatedFileUrl, download: fileName, style: downloadLinkStyle, children: "\uB2E4\uC6B4\uB85C\uB4DC" })] }), _jsx("div", { ref: documentRef, style: previewContainerStyle, children: _jsx("iframe", { src: generatedFileUrl, style: iframeStyle, title: "\uBB38\uC11C \uBBF8\uB9AC\uBCF4\uAE30" }) })] }));
};
// **스타일 정의**

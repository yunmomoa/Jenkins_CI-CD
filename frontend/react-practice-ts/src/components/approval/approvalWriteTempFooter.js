...
const ApprovalWriteTempFooter = ({ approvalData, setApprovalData }) => {
    ...
    return (_jsx("footer", { style: { display: "flex", justifyContent: "center", padding: "20px", gap: "20px" }, children: _jsx("button", { onClick: handleTempSave, style: { background: "#4880FF", color: "white" }, children: "\uC784\uC2DC\uC800\uC7A5" }) }));
};

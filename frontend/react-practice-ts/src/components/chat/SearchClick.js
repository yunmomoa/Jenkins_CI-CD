...
const SearchClick = ({ onProfileClick }) => {
    ...
    return (_jsxs("div", { className: "searchClick", style: { width: "264px", position: "relative" }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", position: "relative" }, children: [_jsx("input", { type: "text", value: searchTerm, onChange: (e) => setSearchTerm(e.target.value), onKeyDown: handleKeyDown, placeholder: "\uC774\uB984 \uAC80\uC0C9", style: {
                            width: "255px",
                            height: "32px",
                            ...
                            fontWeight: "500",
                            color: "#333",
                        } }), _jsx("img", { onClick: handleSearch, className: "searchIcon", style: {
                            width: "20px",
                            height: "20px",
                            position: "absolute",
                            right: "25px",

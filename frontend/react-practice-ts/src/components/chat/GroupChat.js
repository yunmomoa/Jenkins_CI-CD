                    ...
                    return (_jsxs("div", { style: {
                            ...
                            marginBottom: 10,
                                    ...
                                    width: "100%",
                                            ...
                                            .local()
                                            .format("YYYY년 MM월 DD일 dddd") }), _jsx("div", { className: "right-divider", style: { flex: 1, height: "1px", background: "#E0E0E0" } })] })), unread && (_jsx("div", { style: { fontSize: 10, color: "red", marginTop: 2, alignSelf: "flex-end" }, children: unreadCount > 0 && `안 읽은 메시지: ${unreadCount}개` })), !msg.isMine && !isSameUserAsBefore && (_jsxs("div", { style: { display: "flex", alignItems: "center", marginTop: "3px" }, children: [_jsx("div", { style: {
                                            width: "40px",
                                            height: "40px",
                                            background: "#D9D9D9",
                                            borderRadius: "25%",
